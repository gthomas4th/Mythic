...
final class Rosetta {
    static var exists: Bool {
        // Rosetta may be installed while its on-demand daemon is idle.
        FileManager.default.isExecutableFile(atPath: "/Library/Apple/usr/libexec/oah/libRosettaRuntime")
    }
